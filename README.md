...
| TC-05a | `test_posts_collection_returns_100_items` | GET | `/posts` | _(none)_ | Status 200, list length = 100 | Status + Count |
...
| TC-06a | `test_users_collection_returns_10_items` | GET | `/users` | _(none)_ | Status 200, list length = 10 | Status + Count |
...
├── requirements.txt                 # pytest, pytest-html, requests
├── tests/
